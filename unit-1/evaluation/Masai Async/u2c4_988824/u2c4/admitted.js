...
let acceptDetails=JSON.parse(localStorage.getItem("detailsaccept"));

document.querySelector("tbody").innerHTML="";

displayTable(acceptDetails)
function displayTable(acceptDetails){
    acceptDetails.forEach(function(elem){
